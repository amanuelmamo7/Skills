...
Walk the stages in order; each stage's answer gates the next. At every stage, state the conclusion first (CIRAC), and mark the stage **contested** or **uncontested** before deciding how deep to go.
